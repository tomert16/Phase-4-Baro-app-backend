...
puts "🌱 Seeding users..."
joey = User.create(real_name: "Joey", username: "j-money", password_digest: "joey123")
jason = User.create(real_name: "Jason", username: "jay-son", password_digest: "jason123")
tomer = User.create(real_name: "Tomer", username: "tt016", password_digest: "610tt")
kevin = User.create(real_name: "Kevin", username: "km022", password_digest: "220mk")
dan = User.create(real_name: "Daniel", username: "dy008", password_digest: "800yd")
avi = User.create(real_name: "Avi", username: "ar029", password_digest: "920ra")
adam = User.create(real_name: "Adam", username: "af017", password_digest: "710fa")
james = User.create(real_name: "James", username: "jp028", password_digest: "820pj")
olivia = User.create(real_name: "Olivia", username: "or012", password_digest: "210ro")
vero = User.create(real_name: "Veronique", username: "vc004", password_digest: "400cv")
sophia = User.create(real_name: "Sophia", username: "sb030", password_digest: "030bs")
diana = User.create(real_name: "Diana", username: "dp026", password_digest: "620pd")
